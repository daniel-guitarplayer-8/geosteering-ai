...
F7.2.7 ✅ — Benchmark meta ≥ 40 000 mod/h (gate fim Fase 2)                 [CONCLUÍDA (small)]
...
F7.3.2 — _jax/propagation.py: common_arrays com jax.lax.scan                 [PENDENTE]
F7.3.3 — _jax/dipoles.py + _jax/kernel.py: vmap sobre posições               [PENDENTE]
F7.3.4 — GPU support (jax[cuda12]) + benchmark T4/A100                       [PENDENTE]
