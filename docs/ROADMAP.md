...
| **v2.20** | **2026-05-02** | **Investigação empírica rigorosa (5 runs × 2 configs) refuta hipótese "HT-aware = logical cores" e confirma estratégia v2.17 (phys_cores) como ótima. 4w × 2t mediana 46k mod/h em E vs 4w × 4t mediana 38k mod/h (-25%). Documentação expandida + warning empírico no benchmark + novo teste M2/M3 Pro 10-core. Cenário A com defaults v2.20: 1.18M mod/h (6× acima da meta histórica)** | **1 novo (M2/M3 Pro topology)** | **`feat/simulation-manager-v2.20`** |
