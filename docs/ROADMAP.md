...
F7.2.2 — _numba/dipoles.py: hmd_TIV + vmd                                  [PENDENTE]
F7.2.3 — _numba/hankel.py + rotation.py + geometry.py                      [PENDENTE]
F7.2.4 — _numba/kernel.py: orquestrador forward                             [PENDENTE]
F7.2.5 — forward.py: API simulate() + backend dispatch                      [PENDENTE]
F7.2.6 — Validação Numba vs 5 casos analíticos (gate < 1e-10)             [PENDENTE]
F7.2.7 — Benchmark meta ≥ 40 000 mod/h (gate fim Fase 2)                  [PENDENTE]
