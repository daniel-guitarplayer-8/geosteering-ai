...
F7.3.3.3   — VMD native JAX (6 casos análogos ao HMD via `lax.switch`)       [PR #11]
F7.3.3.4   — ETAPAS 3+6 nativas (propagação potenciais + assembly Ward-Hohmann)[PR #12]
...
F7.4.2   — empymod TIV + 9 componentes (ab codes 11/22/55/15/51/12/21/25/52) [PR #11]
