...
use DManisoTIV
implicit none
integer :: nf, ntheta, ncam, modelm, nmaxmodel !, flagdUdL
real(dp) :: h1, dTR, p_med, tj !, hn
real(dp), dimension(:), allocatable :: esp, freq, theta
...
call perfila1DanisoOMP(modelm, nmaxmodel, mypath, nf, freq, ntheta, theta, h1, tj, &
                       dTR, p_med, ncam, resist, esp, filename)
