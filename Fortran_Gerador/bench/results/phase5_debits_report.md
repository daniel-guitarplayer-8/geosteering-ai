# Relatório de Benchmark — phase5_debits

**Gerado em**: 2026-04-05T23:58:52Z
...
|:-------------------------------|:------------------------|
| Iterações                      | 60                      |
| Wall-time médio (s/modelo)     | 0.0693                   |
| Desvio-padrão (s)              | 0.0153                  |
| Mínimo (s)                     | 0.0600                   |
| Máximo (s)                     | 0.1600                   |
| Mediana (s)                    | 0.0700                 |
| **Throughput (modelos/hora)**  | **51923.1**         |
