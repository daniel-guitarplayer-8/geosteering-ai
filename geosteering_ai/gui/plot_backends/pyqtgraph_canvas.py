...
# ╔═══════════════════════════════════════════════════════════════════════════╗
# ║  geosteering_ai/gui/plot_backends/pyqtgraph_canvas.py                     ║
# ║  ---------------------------------------------------------------------    ║
...
# ║    Imports PyQt6 hardcoded substituídos por gui.qt_compat (suporta        ║
...
from geosteering_ai.gui.qt_compat import QtCore, QtGui
